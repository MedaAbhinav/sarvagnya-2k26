          ...
          >
            ...
            >
              ...
              <p className="font-sans text-ivory-300/75 text-sm leading-relaxed mb-2">
                ...
                <strong className="text-gold-400">Sarvagnya 2K26</strong>{" "}
                celebrations?
              </p>
              <p className="font-sans text-ivory-300/55 text-sm leading-relaxed mb-7">
                Every contribution helps us make the College Fest and 2006 Batch
                Alumni Meet truly memorable. Contribution is completely
                optional.
              </p>
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                  ...
                  <div className="text-center">
                    <p
                      className="font-sans text-ivory-400/50 text-xs tracking-[0.2em]
                                  uppercase mb-3 flex items-center justify-center gap-1.5"
                    >
                      <Smartphone size={12} /> Scan with UPI App
                    </p>
                    <div
                      className="inline-block bg-white p-3 mx-auto"
                      style={{ lineHeight: 0 }}
                    >
                      <img
                        src={QR_SRC}
    ...
    >
      ...
      <div className="max-w-2xl mx-auto relative z-10">
        <ScrollReveal className="text-center mb-12">
          <p className="font-script text-gold-400 text-xl mb-3">
            You Belong Here
          </p>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-2">
                  {[
                    {
                      value: "Yes",
                      label: "Yes, I will attend ❤️",
                      sub: "October 10, 2026",
                    },
                    {
                      value: "No",
                      label: "No, I cannot attend",
                      sub: "I will not be present",
                    },
                  ].map((opt) => (
                    <AttendanceCard
                      key={opt.value}
                ...
                <FormSection title="Family" icon="👨‍👩‍👧">
                  <div>
                    ...
                    {errors.familyMembers && (
                      <Err msg={errors.familyMembers.message} />
                    )}
                  </div>
                </FormSection>
