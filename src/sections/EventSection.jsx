...
export default function EventSection() {
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(180deg, #102a43 0%, #0d2238 50%, #102a43 100%)",
      }}
    >
      {/* Decorative */}
          ...
          <ScrollReveal delay={100}>
            ...
            >
              <div className="flex flex-col items-center pt-1">
                <div
                  className="w-10 h-10 rounded-full border border-navy-600 bg-navy-900
                                flex items-center justify-center flex-shrink-0
                                group-hover:border-gold-500/50 transition-colors duration-300"
                >
                  <Star
                    size={16}
                    className="text-navy-400 group-hover:text-gold-500/70 transition-colors duration-300"
                  />
                </div>
              ...
              <div className="pb-10 pt-1">
                ...
                <p className="font-sans text-ivory-400/70 text-sm leading-relaxed">
                  The annual college fest will bring students together for two
                  days of vibrant celebrations, cultural events, and
                  competitions at {COLLEGE.fullName}.
                </p>
              </div>
            </motion.div>
          </ScrollReveal>
            ...
            >
              <div className="flex flex-col items-center pt-1">
                <motion.div
                  animate={{
                    boxShadow: [
                      "0 0 0 0 rgba(196,154,56,0.4)",
                      "0 0 0 14px rgba(196,154,56,0)",
                      "0 0 0 0 rgba(196,154,56,0)",
                    ],
                  }}
                  transition={{
                    duration: 2.5,
              ...
              <div className="pt-1">
                {/* Featured badge */}
                <div
                  className="inline-flex items-center gap-2 bg-gold-500/15 border border-gold-500/40
                                px-3 py-1 mb-3"
                >
                ...
                <div className="premium-card inline-block mt-4">
                  <p className="font-sans text-ivory-300/80 text-sm leading-relaxed max-w-md">
                    <strong className="text-gold-400 font-semibold">
                      October 10 is dedicated entirely
                    </strong>{" "}
                    to welcoming the 2006 Batch back to campus. Reconnect with
                    batchmates, relive your years, and walk through those
                    familiar corridors once more.
                  </p>
                </div>
              </div>
            </motion.div>
